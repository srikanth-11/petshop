...
class animal{
    ...
    constructor(nameof:nameofanimal,ageof:number,charectersticsof:charectersticsofanimal,statusof:statusforadoption){
        this.name=nameof
        this.age=ageof
...
class requirement{
  listofanimalsforadoption(petadoption){
   ...
   getPetsCount(petsinthestore): {dogs:number, cats:number, parrots: number, turtle: number, others:number}{
